...
`sudo apt-get install --fix-missing -y build-essential xserver-xorg-dev libxext-dev1 libxi-dev libglu1-mesa-dev libglew-dev pkg-config` -- see https://github.com/stackgl/headless-gl#ubuntudebian for more.
